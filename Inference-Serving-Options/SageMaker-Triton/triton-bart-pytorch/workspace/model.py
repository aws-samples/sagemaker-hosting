...
class TritonPythonModel:
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            logger.info(">>> inputs ids: %d" % input_ids)
            ...
            np_translation =  translation.cpu().int().detach()
